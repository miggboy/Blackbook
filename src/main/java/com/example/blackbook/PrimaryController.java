...
public class PrimaryController implements Initializable{
    ...
    public void onAddContactClick() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(Blackbook.class.getResource("contactEntry.fxml"));
    ...
    public void onMoreInfoClick() throws IOException {
        ...
        Contact select = contactTable.getSelectionModel().getSelectedItem();
        FXMLLoader loader = new FXMLLoader(Blackbook.class.getResource("infoScreen.fxml"));
